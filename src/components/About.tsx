    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-20 md:py-28">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <Reveal delay={0.2}>
            <Spotlight dark className="bg-[#0E2117] rounded-3xl p-6 md:p-8">
              <div className="flex items-baseline justify-between mb-6">
                <h3 className="font-serif text-2xl md:text-3xl text-[#F7F7F7]">
                  The team
                </h3>
                <span className="text-xs text-white/50">Australia · China</span>
              </div>
